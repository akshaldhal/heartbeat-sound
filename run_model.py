...
# Main function
def main(filename_to_check, delta_time):
    try:
        ...
        # Load the weights
        model.load_state_dict(torch.load("final_model_fcnn_classifier_16_8_7368.pth", weights_only=True))
...
if __name__ == "__main__":
    delta_time = 0.01
    print(main("extracted/archive/DHD/audio/murmur__185_1308073325396_C.wav", delta_time))
